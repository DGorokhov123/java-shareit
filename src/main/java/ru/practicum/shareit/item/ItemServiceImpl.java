...
import ru.practicum.shareit.item.api.*;
...
public class ItemServiceImpl implements ItemService {
    ...
    public CommentResponseDto addComment(Long userId, Long itemId, CommentCreateDto commentCreateDto) {
        ...
        if (!bookingRepository.existsByBookerIdAndItemIdAndStatusAndEndBefore(userId, itemId, BookingStatus.APPROVED, OffsetDateTime.now())) {
